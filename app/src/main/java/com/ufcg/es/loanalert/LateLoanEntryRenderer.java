...
class LateLoanEntryRenderer extends Renderer<LoanEntry> {
    ...
    LateLoanEntryRenderer(Context context) {
    ...
    protected View inflate(LayoutInflater inflater, ViewGroup parent) {
        View inflatedView = inflater.inflate(R.layout.late_loan_entry_item, parent, false);
        ButterKnife.bind(this, inflatedView);
        loanEntryDueDateIcon.setImageDrawable((new IconDrawable(context, "md-warning")
